...
public class TestFourth extends BaseTest {
    @Test
    public void testFourth() {
        ...
        mainPage.checkCurrencyIsDollar()
                .clickIphone();
        String actualResultPriceDollar = iphonePage.getPriceIphoneDollar();
        Assert.assertEquals(actualResultPriceDollar, "123.20");
        iphonePage.changedCurrencyEuro();
        String actualResultPriceEuro = iphonePage.getPriceIphoneEuro();
        Assert.assertEquals(actualResultPriceEuro, "106.04");
        iphonePage.changedCurrencyPound();
        String actualResultPricePound = iphonePage.getPriceIphoneDPound();
